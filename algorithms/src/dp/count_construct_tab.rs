...
mod tests {
  ...
  fn count_construct_count_1_small_string() {
    let count_construct_res =
      count_construct_tab("abcdef", &vec!["ab", "abc", "cd", "def", "abcd"]);
  ...
  fn count_construct_count_2_small_string() {
    let count_construct_res =
      count_construct_tab("purple", &vec!["purp", "p", "ur", "le", "purpl"]);
    assert!(count_construct_res == 2);
  }

  #[test]
  fn count_construct_count_0_small_string() {
    let count_construct_res = count_construct_tab(
      "skateboard",
